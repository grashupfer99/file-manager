...
describe("__formatFileSize__", () => {
  const TEST_CASES = [
    ...
    { input: 768, expected: "768B" },
    { input: 1024, expected: "1KB" },
    { input: 2048, expected: "2KB" },
    { input: 10860, expected: "10.61KB" },
    { input: 34620, expected: "33.81KB" },
    { input: 1048576, expected: "1MB" },
    { input: 2097152, expected: "2MB" },
    { input: 1073741824, expected: "1GB" },
    { input: 1693409494, expected: "1.58GB" },
    { input: 2147483648, expected: "2GB" },
    { input: 1099511627776, expected: "1TB" },
    { input: 2199023255552, expected: "2TB" },
